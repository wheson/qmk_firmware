...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // ` { } _ |      0 1 2 3 = $
  // ,------------------------------------------------.                    .------------------------------------------------.
        ESC , BSLS , LBRC , RBRC ,  AT  , EXLM ,      ,                           , PLUS ,   7  ,   8  ,   9  , PERC , BSPC ,
  // |------+------+------+------+------+------+------|                    |------+------+------+------+------+------+------|
       TABCT, HASH , LPRN , RPRN , TILD , AMPR ,      ,                           , MINS ,   4  ,   5  ,   6  , ASTR , CIRC , 
  // |------+------+------+------+------+------+-------                    |------+------+------+------+------+------+------|
       LSFT , GRV  , LCBR , RCBR , UNDS , PIPE ,      ,                           ,   0  ,   1  ,   2  ,   3  , EQL  , DLR  ,
  // |-------------+------+------+------+------+------+------.      .------+------+------+------+------+------+-------------|
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt)
{
    switch(id) {
        ...
        case UM_KHKR: // タップで「かな」と「変換」、ホールドで「Lower」
        return MACRO_TAP_HOLD_LAYER( record, MACRO(T(HENK), T(LANG1), END), _LOWER );
        };
        return MACRO_NONE;
}
